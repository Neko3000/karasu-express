 ...
 * SDXL Styles Data
 *
 * This file exports the style data directly as a TypeScript constant.
 * Generated from sdxl_styles_exp.json to enable client-side usage.
 *
 * The data is exported as a typed array that can be imported in both
 * server-side and client-side code without requiring Node.js 'fs' module.
 */

import type { RawImportedStyle } from '../../lib/style-types'

/**
 * Pre-loaded SDXL styles data
 * This data is embedded at build time, avoiding runtime file system access.
 */
export const sdxlStylesData: RawImportedStyle[] = [
  {
    name: 'base',
    prompt: '{prompt}',
    negative_prompt: '',
  },
  {
    name: '3D Model',
    prompt:
      'professional 3d model of {prompt}, octane render, highly detailed, volumetric, dramatic lighting',
    negative_prompt: 'ugly, deformed, noisy, low poly, blurry, painting',
  },
  {
    name: 'Abstract',
    prompt:
      'Abstract style art of {prompt}, Non-representational, colors and shapes, expression of feelings, imaginative, highly detailed',
    negative_prompt: 'realistic, photographic, figurative, concrete',
  },
  {
    name: 'Abstract Expressionism',
    prompt:
      'abstract expressionist painting of {prompt}, energetic brushwork, bold colors, abstract forms, expressive, emotional',
    negative_prompt:
  ...
  },
  {
    ...
    prompt:
      'Abstract Expressionism art of {prompt}, High contrast, minimalistic, colorful, stark, dramatic, expressionism',
    negative_prompt:
  ...
  },
  {
    name: 'Action Figure',
    prompt:
      'Action Figure of {prompt}, plastic collectable action figure, collectable toy action figure',
    negative_prompt: 'ugly, deformed, noisy, blurry, low contrast',
  },
  {
    name: 'Adorable 3D Character',
    prompt:
      'Adorable 3D Character of {prompt}, 3D render, adorable character, 3D art',
    negative_prompt:
  ...
  },
  {
    name: 'Analog Film',
    prompt:
      'analog film photo of {prompt}, faded film, desaturated, 35mm photo, grainy, vignette, vintage, Kodachrome, Lomography, stained, highly detailed, found footage',
    negative_prompt:
  ...
  },
  {
    name: 'Art Nouveau 2',
    prompt:
      'Art Nouveau art of {prompt}, sleek, organic forms, long, sinuous, art nouveau style',
    negative_prompt:
  ...
  },
  {
    ...
    prompt:
      'Blueprint Schematic Drawing of {prompt}, technical drawing, blueprint, schematic',
    negative_prompt: 'ugly, deformed, noisy, blurry, low contrast',
  },
  {
  ...
  },
  {
    name: 'Cel Shaded Art',
    prompt:
      'Cel Shaded Art of {prompt}, 2D, flat color, toon shading, cel shaded style',
    negative_prompt: 'ugly, deformed, noisy, blurry, low contrast',
  },
  {
    name: 'Character Design Sheet',
    prompt:
      'Character Design Sheet of {prompt}, character reference sheet, character turn around',
    negative_prompt: 'ugly, deformed, noisy, blurry, low contrast',
  },
  {
    name: 'Cinematic Film',
  ...
  },
  {
    ...
    prompt:
      'UHD, 4k, ultra detailed, cinematic, a photograph of {prompt}, epic, beautiful lighting, inpsiring',
    negative_prompt: 'ugly, deformed, noisy, blurry, low contrast, realistic',
  },
  {
    name: 'Classicism Art',
  ...
  },
  {
    ...
    prompt:
      'Color Field Painting {prompt}, abstract, simple, geometric, color field painting style',
    negative_prompt: 'ugly, deformed, noisy, blurry, low contrast',
  },
  {
    name: 'Colored Pencil Art',
    prompt:
      'Colored Pencil Art of {prompt}, colored pencil strokes, light color, visible paper texture, colored pencil art',
    negative_prompt: 'ugly, deformed, noisy, blurry, low contrast',
  },
  {
    name: 'Commercial Illustration 1920s',
    prompt:
      "1920s commercial illustration of {prompt}, magazine cover illustration from the 1920's, exaggerated realism, a hint of caricature",
    negative_prompt:
      'monochromatic, ugly, deformed, noisy, blurry, low contrast, photo, photograph, realistic, low res',
  },
  {
    name: 'Comic Book',
    prompt:
      'comic book art of {prompt}, comic art, graphic novel illustration',
    negative_prompt:
  ...
  },
  {
    ...
    prompt:
      'Constructivism Art of {prompt}, minimalistic, geometric forms, flat, 2D, constructivism art',
    negative_prompt: 'ugly, deformed, noisy, blurry, low contrast',
  },
  {
    name: 'Craft Clay',
    prompt:
      'play-doh style sculpture of {prompt}, sculpture, clay art, centered composition, Claymation',
    negative_prompt:
  ...
  },
  {
    name: 'Cubism 1',
    prompt:
      'Cubist artwork of {prompt}, Geometric shapes, abstract, innovative, revolutionary',
    negative_prompt:
  ...
  },
  {
    name: 'Cubism 2',
    prompt:
      'Cubism Art of {prompt}, flat geometric forms, 2D, limited color palette, cubism art',
    negative_prompt: 'ugly, deformed, noisy, blurry, low contrast',
  },
  {
    name: 'Cybernetic',
  ...
  },
  {
    name: 'Cyberpunk',
    prompt:
      'cyberpunk style, {prompt}, neon, dystopian, futuristic, digital, vibrant, detailed, high contrast, reminiscent of cyberpunk genre',
    negative_prompt: 'historical, natural, rustic, low detailed',
  },
  {
    name: 'DMT Art Style',
    prompt:
      'DMT Art Style of {prompt}, bright colors, surreal visuals, swirling patterns, DMT art style',
    negative_prompt: 'ugly, deformed, noisy, blurry, low contrast',
  },
  {
    name: 'Dadaism',
  ...
  },
  {
    name: 'Digital Art',
    prompt:
      'concept art of {prompt}, digital artwork, illustrative, painterly, matte painting, highly detailed',
  ...
  },
  {
    ...
    prompt:
      'Double Exposure photography, {prompt}, double image ghost effect, image combination, double exposure style',
    negative_prompt: 'ugly, deformed, noisy, blurry, low contrast',
  },
  {
    name: 'Dreamscape',
  ...
  },
  {
    ...
    prompt:
      'Expressionism Art Style, an expressionist painting of {prompt}, visible brush strokes, contrast, emotional, exaggerated forms, expressionism art style',
    negative_prompt:
      'ugly, deformed, noisy, blurry, low contrast, realistic, photograph, photo',
  },
  {
    name: 'Faded Polaroid Photo',
    prompt:
      'Faded Polaroid Photo of {prompt}, analog, old faded photo, old polaroid',
    negative_prompt:
  ...
  },
  {
    name: 'Fauvism',
    prompt:
      'Fauvism Art of {prompt}, painterly, bold colors, textured brushwork, fauvism art',
    negative_prompt: 'ugly, deformed, noisy, blurry, low contrast',
  },
  {
    name: 'Fighting Game',
  ...
  },
  {
    name: 'Flat 2D Art',
    prompt:
      'Flat 2D Art of {prompt}, simple flat color, 2-dimensional, Flat 2D Art Style',
    negative_prompt:
  ...
  },
  {
    name: 'Flat Papercut',
    prompt:
      'Flat papercut style, papercut art of {prompt}, Silhouette, clean cuts, paper, sharp edges, minimalist, color block',
    negative_prompt:
  ...
  },
  {
    ...
    prompt:
      'sci-fi style, {prompt}, futuristic, technological, space themes, advanced civilizations',
    negative_prompt:
      'ugly, deformed, noisy, blurry, low contrast, realism, photorealistic, historical, medieval',
  },
  {
    name: 'GTA',
    prompt:
      'GTA style art of {prompt}, satirical, exaggerated, GTA art style, vibrant colors, iconic characters, action-packed',
    negative_prompt:
  ...
  },
  {
    name: 'Glamour',
    prompt:
      'glamorous photo of {prompt}, high fashion, luxurious, extravagant, stylish, sensual, opulent, elegance, stunning beauty, professional, high contrast, detailed',
    negative_prompt:
  ...
  },
  {
    name: 'Graffiti Art 1',
    prompt:
      'Graffiti art of {prompt}, Street art, vibrant, urban, detailed, tag, mural',
    negative_prompt:
      'ugly, deformed, noisy, blurry, low contrast, realism, photorealistic',
  },
  {
    name: 'Graffiti Art 2',
    prompt:
      'Graffiti art of {prompt}, dynamic, dramatic, vibrant colors, bold lines, graffiti art style',
    negative_prompt: 'ugly, deformed, noisy, blurry, low contrast',
  },
  {
    name: 'Grunge',
  ...
  },
  {
    name: 'Hyperrealism',
    prompt:
      'Hyperrealistic art of {prompt}, Extremely high-resolution details, photographic, realism pushed to extreme, fine texture, incredibly lifelike',
    negative_prompt:
  ...
  },
  {
    ...
    prompt:
      'Impressionist painting of {prompt}, loose brushwork, vibrant color, light and shadow play, captures feeling over form',
    negative_prompt:
      'anime, photorealistic, 35mm film, deformed, glitch, low contrast, noisy',
  },
  {
    ...
    prompt:
      'Impressionism art of {prompt}, painterly, small brushstrokes, visible brushstrokes, impressionistic style',
    negative_prompt: 'ugly, deformed, noisy, blurry, low contrast',
  },
  {
  ...
  },
  {
    ...
    prompt:
      'Ink Dripping Drawing of {prompt}, ink drawing, ink splash, ink wash, dripping ink',
    negative_prompt:
  ...
  },
  {
    ...
    prompt:
      'isometric style, {prompt}, vibrant, beautiful, crisp, detailed, ultra detailed, intricate, isometric style',
    negative_prompt:
  ...
  },
  {
    ...
    prompt:
      'Japanese Style Ink Drawing of {prompt}, ink drawing, inkwash, Japanese Style Ink Drawing',
    negative_prompt:
      'ugly, deformed, noisy, blurry, low contrast, colorful, vibrant',
  },
  {
  ...
  },
  {
    ...
    prompt:
      'Legend of Zelda style art of {prompt}, Vibrant, fantasy, detailed, epic, heroic, reminiscent of The Legend of Zelda series',
  ...
  },
  {
    name: 'Line Art',
    prompt:
      'line art drawing of {prompt}, professional, sleek, modern, minimalist, graphic, line art, vector graphics',
    negative_prompt:
  ...
  },
  {
    name: 'Logo Design',
    prompt:
      'Logo Design of {prompt}, dynamic graphic art, vector art, minimalist, professional logo design',
    negative_prompt: 'ugly, deformed, noisy, blurry, low contrast',
  },
  {
    name: 'Long Exposure',
  ...
  },
  {
    ...
    prompt:
      'Macro Photography, macro photograph of {prompt}, close-up, macro 100mm, macro photography',
    negative_prompt: 'ugly, deformed, noisy, blurry, low contrast',
  },
  {
    name: 'Mandala Art',
    prompt:
      'Mandala style art of {prompt}, complex, circular design, mandala art',
    negative_prompt: 'ugly, deformed, noisy, blurry, low contrast',
  },
  {
    name: 'Manga',
    prompt:
      'manga style art of {prompt}, vibrant, high-energy, detailed, iconic, Japanese comic style, manga',
    negative_prompt:
  ...
  },
  {
    name: 'Marker Drawing',
    prompt:
      'Marker Drawing of {prompt}, bold marker lines, visibile paper texture, marker drawing',
    negative_prompt:
  ...
  },
  {
    name: 'Medievalism',
    prompt:
      'Medievalism, medival art of {prompt}, inspired by The Middle Ages, medieval art, elaborate patterns and decoration, Medievalism',
    negative_prompt: 'ugly, deformed, noisy, blurry, low contrast',
  },
  {
    name: 'Metropolis',
  ...
  },
  {
    name: 'Minecraft',
    prompt:
      'Minecraft style art of {prompt}, Blocky, pixelated, vibrant colors, recognizable characters and objects, game assets, Minecraft style',
    negative_prompt:
  ...
  },
  {
    name: 'Minimalism 2',
    prompt:
      'Minimalism art of {prompt}, abstract, simple geometric shapes, hard edges, sleek contours, Minimalism',
    negative_prompt: 'ugly, deformed, noisy, blurry, low contrast',
  },
  {
    name: 'Monochrome',
    prompt:
      'Monochrome, {prompt}, contrast, tone, texture, detailed, Monochromatic',
  ...
  },
  {
    name: 'Op Art',
    prompt:
      'Op Art of {prompt}, optical illusion, abstract, geometric pattern, impression of movement, Op Art',
    negative_prompt: 'ugly, deformed, noisy, blurry, low contrast',
  },
  {
    name: 'Origami',
  ...
  },
  {
    name: 'Pencil Sketch',
    prompt:
      'Pencil Sketch Drawing of {prompt}, black and white drawing, pencil sketch, graphite drawing',
    negative_prompt: 'ugly, deformed, noisy, blurry, low contrast',
  },
  {
    name: 'Photographic',
    prompt:
      'cinematic photo of {prompt}, 35mm photograph, film, bokeh, professional, 4k, highly detailed',
    negative_prompt:
  ...
  },
  {
    name: 'Pointillism',
    prompt:
      'Pointillism style painting of {prompt}, Composed entirely of small distinct dots of color, vibrant, highly detailed, pointillism',
    negative_prompt:
  ...
  },
  {
    name: 'Pokemon',
    prompt:
      'Pokemon style art of {prompt}, Vibrant, cute, anime, fantasy, reminiscent of Pokemon series',
    negative_prompt: 'realistic, modern, horror, dystopian, violent',
  },
  {
    name: 'Pop Art 1',
    prompt:
      'Pop Art style, art of {prompt}, Bright colors, bold outlines, popular culture themes, ironic or kitsch',
    negative_prompt:
  ...
  },
  {
    name: 'Pop Art 2',
    prompt:
      'Pop Art, art of {prompt}, vivid colors, flat color, 2D, strong lines, Pop Art',
    negative_prompt:
      'ugly, deformed, noisy, blurry, low contrast, photo, realistic',
  },
  {
  ...
  },
  {
    name: 'RPG Fantasy',
    prompt:
      'Role-playing game (RPG) style fantasy, {prompt}, Detailed, vibrant, immersive, reminiscent of fantasy RPG games',
  ...
  },
  {
    name: 'Retro Game',
    prompt:
      'Retro game art of {prompt}, 16-bit, vibrant colors, pixelated, nostalgic, charming, fun',
    negative_prompt:
  ...
  },
  {
    ...
    prompt:
      'retro cyberpunk, {prompt}, 1980s inspired, synthwave, neon, vibrant, detailed, retro futurism',
    negative_prompt:
  ...
  },
  {
    name: 'Retro Futurism',
    prompt:
      'retro-futuristism, {prompt}, vintage sci-fi, 1950s and 1960s style, atomic age, vibrant, highly detailed, retro futurism',
  ...
  },
  {
    name: 'Silhouette Art',
    prompt:
      'Silhouette Art of {prompt}, high contrast, well defined, Silhouette Art',
    negative_prompt: 'ugly, deformed, noisy, blurry, low contrast',
  },
  {
    name: 'Simple Vector Art',
    prompt:
      'Simple Vector Art of {prompt}, 2D flat, simple shapes, minimalistic, professional graphic, flat color, high contrast, Simple Vector Art',
    negative_prompt:
      'ugly, deformed, noisy, blurry, low contrast, 3D, photo, realistic',
  },
  {
  ...
  },
  {
    ...
    prompt:
      'Vector Art Stickers of {prompt}, professional vector art, sticker designs, Sticker Sheet',
    negative_prompt: 'ugly, deformed, noisy, blurry, low contrast',
  },
  {
    name: 'Strategy Game',
  ...
  },
  {
    name: 'Street Fighter',
    prompt:
      'Street Fighter style 2D art of {prompt}, Vibrant, dynamic, arcade, 2D fighting game, highly detailed, reminiscent of Street Fighter series',
    negative_prompt:
  ...
  },
  {
    name: 'Super Mario',
    prompt:
      'Super Mario style art of {prompt}, Vibrant, cute, cartoony, fantasy, playful, reminiscent of Super Mario series',
    negative_prompt: 'realistic, modern, horror, dystopian, violent',
  },
  {
    name: 'Suprematism',
  ...
  },
  {
    name: 'Surrealism 2',
    prompt:
      'Surrealism, {prompt}, expressive, dramatic, organic lines and forms, dreamlike, mysterious, Surrealism',
    negative_prompt: 'ugly, deformed, noisy, blurry, low contrast, realistic',
  },
  {
  ...
  },
  {
    name: 'Texture',
    prompt:
      'texture asset, seamless texture of {prompt}, close-up, texture detail, tileable texture',
  ...
  },
  {
    name: 'Typography',
    prompt:
      'Typographic art of {prompt}, Stylized, intricate, detailed, artistic, text-based',
    negative_prompt:
      'ugly, deformed, noisy, blurry, low contrast, realism, photorealistic',
  },
  {
  ...
  },
  {
    ...
    prompt:
      'Vibrant Rim Light, {prompt}, back lighting, beautiful lighting, colored rim light, high contrast',
    negative_prompt: 'ugly, deformed, noisy, blurry, low contrast',
  },
  {
  ...
  },
  {
    name: 'Watercolor 1',
    prompt:
      'Watercolor painting of {prompt}, Vibrant, beautiful, painterly, detailed, textural, artistic',
    negative_prompt:
      'anime, photorealistic, 35mm film, deformed, glitch, low contrast, noisy',
  },
  {
    name: 'Watercolor 2',
    prompt:
      'Watercolor style painting of {prompt}, visible paper texture, colorwash, watercolor art',
    negative_prompt:
      'ugly, deformed, noisy, blurry, low contrast, photo, realistic',
  },
  {
  ...
  },
  {
    name: 'Wild West',
    prompt:
      'wild west style, {prompt}, the old west, historical, rustic, the wild west',
    negative_prompt:
      'ugly, deformed, noisy, blurry, low contrast, drab, boring, moody',
  },
  {
